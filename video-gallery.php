...
$stmt2 = $auth_user->runQuery("SELECT * FROM uploads");
$stmt2->execute();
      ...
      <h1>
        ...
        <div class="row">
          ...
          <?php foreach ($upload_data as $file): ?>
            <?php if (file_exists($file['file_upload'])): ?>
              <?php $file_extension = pathinfo($file['file_upload'])['extension']; ?>
              <?php
              ...
              <?php if (in_array($file_extension, $image_file_extensions)): ?>
                <div class="col-xs-6 col-md-3">
                  <img src="<?php echo $file['file_upload'] ?>" alt="" width="300" height="300"> 
                </div>
              <?php endif ?>
              <?php if (in_array($file_extension, $document_file_extensions)): ?>
                <div class="col-xs-6 col-md-3">
                  <iframe src="<?php echo $file['file_upload'] ?>" width="300" height="300"></iframe> 
                </div>
              <?php endif ?>
              <?php if (in_array($file_extension, $video_file_extensions)): ?>
              <div class="col-xs-6 col-md-3">
              <video src="<?php echo $file['file_upload'] ?>"  controls width="300" height="300"></video>
            </div>
