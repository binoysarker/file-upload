    ...
    <div class="container">
      ...
      <h1>
        ...
        <div class="upload-form">
          <form class="form-upload" method="post" id="login-form" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <input type="text" class="form-control" name="user_number" placeholder="Phone (727)688-5945" required />
              <span id="check-e"></span>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="user_subject" placeholder="Subject" required />
              <span id="check-subject"></span>
            </div>
            <div class="form-group">
              <textarea name="user_info" placeholder="Information" class="form-control" rows="10"></textarea>
            </div>

            <div class="form-group">
              <input type="file" name="file_upload[]" multiple value="" placeholder="Upload">
            </div>
            <div class="form-group">
              <input type="file" name="file_upload[]" multiple value="" placeholder="Upload">
            </div>
